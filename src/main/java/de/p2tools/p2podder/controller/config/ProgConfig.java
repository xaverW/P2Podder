...
public class ProgConfig extends PDataProgConfig {
    ...
    public static BooleanProperty SYSTEM_SMALL_ROW_TABLE_PODCAST = addBool("system-small-row-table-podcast", Boolean.FALSE);
    public static BooleanProperty SYSTEM_SMALL_ROW_TABLE_EPISODE = addBool("system-small-row-table-episode", Boolean.FALSE);
