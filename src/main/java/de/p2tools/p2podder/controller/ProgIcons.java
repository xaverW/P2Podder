...
public class ProgIcons {
    ...
    public static P2Image IMAGE_ATTENTION_64 = new P2Image(ICON_PATH_LONG, "attention-64.png", 64, 64);
    public static P2Image ICON_MENU_SMALL_PODDER_24 = new P2Image(ICON_PATH_LONG, "menu-smallPodder-24.png", 24, 24);
    public static P2Image ICON_MENU_SMALL_PODDER_20 = new P2Image(ICON_PATH_LONG, "menu-smallPodder-20.png", 20, 20);
    ...
    public static P2Image ICON_BUTTON_PLAY_NEXT = new P2Image(ICON_PATH_LONG, "button-play-next.png", 16, 16);
    public static P2Image ICON_BUTTON_QUIT = new P2Image(ICON_PATH_LONG, "button-quit_16.png", 16, 16);
    public static P2Image ICON_BUTTON_RANDOM = new P2Image(ICON_PATH_LONG, "button-random.png", 16, 16);
    public static P2Image ICON_BUTTON_REMOVE = new P2Image(ICON_PATH_LONG, "button-remove.png", 16, 16);
    public static P2Image ICON_BUTTON_STOP_PLAY = new P2Image(ICON_PATH_LONG, "button-stop-play.png", 16, 16);
    ...
    public static P2Image IMAGE_TABLE_DEL = new P2Image(ICON_PATH_LONG, "table-del.png", 14, 14);
    public static P2Image IMAGE_TABLE_DOWNLOAD_START = new P2Image(ICON_PATH_LONG, "table-download-start.png", 14, 14);
    public static P2Image IMAGE_TABLE_BACK = new P2Image(ICON_PATH_LONG, "table-back.png", 14, 14);
    public static P2Image IMAGE_TABLE_FILE_OPEN = new P2Image(ICON_PATH_LONG, "table-file-open.png", 14, 14);
    public static P2Image IMAGE_TABLE_UPDATE = new P2Image(ICON_PATH_LONG, "table-update.png", 14, 14);
    public static P2Image IMAGE_TABLE_PLAY = new P2Image(ICON_PATH_LONG, "table-play.png", 14, 14);
    public static P2Image IMAGE_TABLE_OFF = new P2Image(ICON_PATH_LONG, "table-off.png", 14, 14);
    public static P2Image IMAGE_TABLE_STOP = new P2Image(ICON_PATH_LONG, "table-stop.png", 14, 14);
