...
public class Starter {
    ...
    public EpisodeStarterFactory getStartPlayingEpisode() {
        return episodeStarterFactory;
    }

    public void setStartPlayingEpisode(EpisodeStarterFactory episodeStarterFactory) {
        this.episodeStarterFactory = episodeStarterFactory;
    }
