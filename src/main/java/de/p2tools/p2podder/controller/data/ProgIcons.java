...
public class ProgIcons {
    ...
    public enum Icons {
        ...
        ICON_FILTER_EPISODE_LOAD("filter-episode-load.png", 15, 15),
        ICON_FILTER_EPISODE_SAVE("filter-episode-save.png", 15, 15),
        ICON_FILTER_EPISODE_NEW("filter-episode-new.png", 15, 15),
