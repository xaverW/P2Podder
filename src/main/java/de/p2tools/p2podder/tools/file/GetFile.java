...
package de.p2tools.p2podder.tools.file;
...
public class GetFile {
    ...
    public static final String PATH_PSET_LINUX = "/de/p2tools/p2podder/tools/file/pset_linux.xml";
    public static final String PATH_PSET_WINDOWS = "/de/p2tools/p2podder/tools/file/pset_windows.xml";
