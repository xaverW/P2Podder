...
import de.p2tools.p2podder.controller.starterDownload.MTNotification;
...
public class MTPTester {
    ...
    private void addProgTest() {
        if (progInfoDialog != null) {
            ...
            btnNotify.setOnAction(a -> MTNotification.addNotification(new Episode(), true));
...
//                }
    ...
    private void startWaiting() {
        maskerPane.setMaskerText("Podcastliste ist zu alt, eine neue downloaden");
