...
public class StartPaneColorMode {
    ...
    public TitledPane make() {
        ...
        return new TitledPane("Farbe der Programmoberfläche", vBox);
    }
    ...
    private void makeImage() {
        ...
        String path = "/de/p2tools/p2podder/res/startdialog/startdialog-color-" + 0 + ".png";
        ...
        path = "/de/p2tools/p2podder/res/startdialog/startdialog-color-" + 1 + ".png";
        ...
        path = "/de/p2tools/p2podder/res/startdialog/startdialog-color-" + 2 + ".png";
        image = new Image(path, size, size, true, true);
        iv2.setSmooth(true);
        iv2.setImage(image);
        ...
        path = "/de/p2tools/p2podder/res/startdialog/startdialog-color-" + 3 + ".png";
        image = new Image(path, size, size, true, true);
        iv3.setSmooth(true);
        iv3.setImage(image);
