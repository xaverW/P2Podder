...
public class PodcastFilterClear extends VBox {
    ...
    public PodcastFilterClear() {
        super();
        progData = ProgData.getInstance();
        progData.podcastFilterClear = this;
        setSpacing(20);
    ...
    private void addButton() {
        StoredFilters storedFilters = progData.podcastGui.getStoredFiltersPodcast();

        btnGoBack.setGraphic(new ProgIcons().ICON_BUTTON_BACKWARD);
        btnGoBack.setOnAction(a -> storedFilters.getStoredFiltersForwardBackward().goBackward());
        btnGoBack.disableProperty().bind(storedFilters.getStoredFiltersForwardBackward().backwardProperty().not());
        ...
        btnGoForward.setOnAction(a -> storedFilters.getStoredFiltersForwardBackward().goForward());
        btnGoForward.disableProperty().bind(storedFilters.getStoredFiltersForwardBackward().forwardProperty().not());
    ...
    private void clearFilter() {
        progData.podcastGui.getPodcastFilterController().clearFilter();
    }
}
