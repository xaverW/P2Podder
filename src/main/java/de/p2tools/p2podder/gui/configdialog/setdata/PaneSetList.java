...
public class PaneSetList extends TitledPane {
    ...
    private void initTable(VBox vBox) {
        ...
        btnDel.setGraphic(ProgIconsP2Podder.ICON_BUTTON_REMOVE.getImageView());
        ...
        btnNew.setGraphic(ProgIconsP2Podder.ICON_BUTTON_ADD.getImageView());
        ...
        btnUp.setGraphic(ProgIconsP2Podder.ICON_BUTTON_MOVE_UP.getImageView());
        ...
        btnDown.setGraphic(ProgIconsP2Podder.ICON_BUTTON_MOVE_DOWN.getImageView());
