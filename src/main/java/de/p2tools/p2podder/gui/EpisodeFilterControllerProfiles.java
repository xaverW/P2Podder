...
import de.p2tools.p2podder.controller.storedFilter.SelectedFilter;
import de.p2tools.p2podder.controller.storedFilter.SelectedFilterFactory;
...
public class EpisodeFilterControllerProfiles extends VBox {
    ...
    private final IntegerProperty filterProp = ProgConfig.FILTER_EPISODE_SEL_FILTER;
    ...
    private void initButton() {
        ...
        btnLoadFilter.setGraphic(new ProgIcons().ICON_FILTER_EPISODE_LOAD);
        ...
        btnSaveFilter.setGraphic(new ProgIcons().ICON_FILTER_EPISODE_SAVE);
        ...
        btnNewFilter.setGraphic(new ProgIcons().ICON_FILTER_EPISODE_NEW);
